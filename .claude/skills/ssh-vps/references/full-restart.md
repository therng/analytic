...
VERIFY after: `ssh forexvps 'powershell -NoProfile -Command "Get-Process terminal64 | Select-Object Id, ProcessName, Path"'` + `ssh forexvps 'nssm status bridge'`; heartbeat check (status-check.md) if anything looks off.
