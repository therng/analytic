...
def sharpe_sortino_from_deals(deals, timeframe_minutes=None):
    """
    deals: list of dicts with 'balance_after' and 'time' fields from runtime data
...
| What you want | Use |
|---|---|
| Runtime Sharpe | Compute from runtime return series per project contract |
