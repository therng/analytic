...
`AccountReportResult.sharpeRatio` is a cache written from current `Deal` data. Do not treat cached aggregate fields as more authoritative than runtime tables.
