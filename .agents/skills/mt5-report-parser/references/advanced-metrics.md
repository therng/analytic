...
The average monetary result of the next trade. Positive = profitable on average. This is `metrics.expected_payoff` in parsed JSON and `<!--REPORT_EXPECTEDPAYOFF-->` in the HTML template.
