...
Key ones (no `.env.example` currently in-tree; ask the operator for reference local/test values — the old `.env.test.example` was removed with the Docker test stack in 8.46):
