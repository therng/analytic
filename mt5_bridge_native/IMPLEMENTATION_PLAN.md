...
- [ ] **Step 2: Write online-backup/restore tests**
...
- [ ] **Step 4: Implement fail-closed checks and online backup**
...
- [ ] **Step 1: Write local duplicate-writer tests**
...
- [ ] **Step 2: Write Redis fencing tests**
...
- [ ] **Step 4: Implement local lock and Lua-backed Redis operations**
...
- [ ] **Step 1: Write window-planning and ordering tests**
...
- [ ] **Step 5: Implement minimal window and reconciliation machines**
...
- [ ] **Step 6: Run tests under multiple hash seeds and commit**
...
- [ ] **Step 2: Write sequence and fencing tests**
...
- [ ] **Step 4: Implement serialized polling and fenced publication**
